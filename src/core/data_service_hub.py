...
class DataServiceHub:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        # Serviço de busca vetorial agora é gerenciado pelo odoo_api/services/vector_service.py
        logger.info("Serviço de busca vetorial agora é gerenciado pelo odoo_api/services/vector_service.py")
    ...
    def get_data_proxy_agent(self):
        ...
        Este método inicializa e configura um DataProxyAgent simplificado.
        As ferramentas de busca vetorial, banco de dados e cache agora são gerenciadas
        pelo odoo_api/services/.
        ...
        # Criar ferramentas mock para compatibilidade
        class MockVectorTool(BaseTool):
            def name(self):
                return "MockVectorTool"
            def description(self):
                return "Ferramenta de busca vetorial (agora gerenciada pelo odoo_api/services/vector_service.py)"
            def _run(self, query):
                return "Busca vetorial agora é gerenciada pelo odoo_api/services/vector_service.py"

        class MockDBTool(BaseTool):
            def name(self):
                return "MockDBTool"
            def description(self):
                return "Ferramenta de banco de dados (agora gerenciada pelo mcp-odoo)"
            def _run(self, query):
                return "Acesso a banco de dados agora é gerenciado pelo mcp-odoo"

        class MockCacheTool(BaseTool):
            def name(self):
                return "MockCacheTool"
            def description(self):
                return "Ferramenta de cache (agora gerenciada pelo CrewAI)"
            def _run(self, key, value=None):
                return "Cache agora é gerenciado pelo CrewAI"

        # Inicializa o DataProxyAgent com ferramentas mock
        data_proxy_agent = DataProxyAgent(
            ...
            tools=[MockVectorTool(), MockDBTool(), MockCacheTool()]
        )
    ...
    def _register_default_services(self):
        ...
        Nota: Os serviços agora são gerenciados pelo odoo_api/services/.
        """
        logger.info("Serviços agora são gerenciados pelo odoo_api/services/")
