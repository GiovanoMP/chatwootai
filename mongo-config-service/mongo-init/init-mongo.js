...
// Criar coleção única para o módulo company_services
db.createCollection('company_services');

// Criar índices
db.company_services.createIndex({ "account_id": 1 }, { unique: true });
db.company_services.createIndex({ "updated_at": 1 });

// Inserir uma configuração de exemplo
db.company_services.insertOne({
