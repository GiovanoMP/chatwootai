#!/usr/bin/env python
"""
Chat interativo com agentes do CrewAI que acessam o Qdrant.

Este script permite interagir diretamente com os agentes do CrewAI,
fazendo perguntas e recebendo respostas baseadas nos dados do Qdrant.
"""
...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Chat interativo com agentes do CrewAI")
...
def main():
    ...
    print(f"Bem-vindo ao chat interativo com agentes do CrewAI para a conta {args.account_id}")
    ...
    print("\nObrigado por usar o chat interativo com agentes do CrewAI!")
