...
echo "Agora você pode atualizar a lista de módulos no Odoo e instalar 'Descrições Semânticas de Produtos'"
...
echo "   - Busque por 'Descrições Semânticas' e instale o módulo"
echo ""
echo "2. Para verificar os logs do módulo:"
echo "   - Logs do Odoo: sudo tail -f /var/log/odoo/odoo-server.log | grep semantic"
echo "   - Logs específicos do módulo: sudo tail -f /var/log/odoo/semantic_product_description.log"
echo ""
